...
ddsTxi_kegg <- DESeqDataSetFromTximport(obs_counts,
                                        colData = obs,
...
write_tsv(norm_amr, "outputs/functional_tables/antibiotic_resistance/observational_amr_norm_counts.tsv")
...
write_tsv(norm_vitamin, "outputs/functional_tables/vitamins//observational_vitamins_norm_counts.tsv")
...
write_tsv(norm_metabolism, "outputs/functional_tables/metabolism/observational_ko01100_norm_counts.tsv")
